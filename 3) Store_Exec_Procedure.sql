--PROCEDURE FOR LOADING ONTO REPO TABLE AND EXECUTING THE SCRIPT
--UPDATE THE SQL FILE NAME IN THE EXEC PROCEDURE
...
EXEC load_script_to_db(--UPDATE SQL FILE NAME);